    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'base_urls' => [
                ...
                'agent_image_url' => asset('storage/agent'),
                'linked_website_image_url' => asset('storage/website'),
                'purpose_image_url' => asset('storage/purpose'),
                'notification_image_url' => asset('storage/notification'),
                'company_image_url' => asset('storage/business'),
