                ...
                <div class="row">
                    ...
                    @if(isset($config) && $config['status'])
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card" onclick="$('#ssl-form').submit()">
                                <div class="card-body" style="height: 70px">
                                    <form action="{{ url('/cryptomus/make-payment') }}" method="POST" class="needs-validation"
                                          id="ssl-form">
                                        <input type="hidden" value="{{ csrf_token() }}" name="_token"/>
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{asset('assets/admin/img/cryptomus.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                    ...
                    @if(isset($config) && $config['status'])
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card" onclick="$('#ssl-form').submit()">
                                <div class="card-body" style="height: 70px">
                                    <form action="{{ url('/cinetpay/make-payment') }}" method="POST" class="needs-validation"
                                          id="ssl-form">
                                        <input type="hidden" value="{{ csrf_token() }}" name="_token"/>
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{asset('assets/admin/img/logo-cinetpay.webp')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    ...
                                    ?>
                                    <form action="{{ route('payment-razor', ['user_id'=>session('user_id'), 'amount'=>session('amount')]) }}" method="POST">
                                    @csrf
...
{{--                                                <input type="hidden" name="orderID" value="{{ $id }}">--}}
                    ...
                    @if(isset($config) && $config['status'])
                        ...
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    <button class="btn btn-block p-1 click-if-alone" id="bKash_button" onclick="BkashPayment()">
