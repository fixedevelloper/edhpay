...
<div id="sidebarMain" class="d-none">
    <aside
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between">
                ...
                <a class="navbar-brand" href="{{route('admin.dashboard')}}" aria-label="Front">
                    <img class="navbar-brand-logo" style="max-height: 55px; border-radius: 8px;max-width: 100%!important;"
                         ...
                         src="{{asset('/assets/log.jpg')}}"
                         alt="Logo">
                    <img class="navbar-brand-logo-mini" style="max-height: 55px; border-radius: 8px;"
                         onerror="this.src='{{asset('/assets/admin/img/160x160/img2.jpg')}}'"
                         src="{{asset('/assets/log.png')}}" alt="Logo">
                  {{--  <img class="navbar-brand-logo" style="max-height: 55px; border-radius: 8px;max-width: 100%!important;"
                         onerror="this.src='{{asset('/assets/admin/img/1920x400/img2.jpg')}}'"
            ...
            <!-- Content -->
            <div class="navbar-vertical-content" style="background-color: #2a2a2a;">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/withdrawal-methods*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                           href="{{route('admin.withdrawal_methods.add')}}">
                            ...
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{translate('Add_withdrawal_methods')}}
                            </span>
                        </a>
                    </li>
                    <!-- End Pages -->
