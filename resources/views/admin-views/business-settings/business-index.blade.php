                    ...
                    <div class="row">
                        <div class="col-md-3 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="agent_commission_percent" class="form-control" id="agent_commission_percent" value="{{$agent_commission_percent??''}}" min="0" step=".02" max="100" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="cashout_charge_percent" class="form-control" id="cashout_charge_percent" value="{{$cashout_charge_percent??1}}" min="0" step=".02" max="100" required>
                            </div>
                        </div>
                        <div class="col-md-3 col-12">
                        ...
                        <div class="col-md-3 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="sendmoney_charge_flat" class="form-control" id="sendmoney_charge_flat" value="{{$sendmoney_charge_flat??0}}" min="0" step=".02" required>
                            </div>
                        </div>
                    </div>
